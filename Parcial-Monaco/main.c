...
{
    int opcionMenu = 0;
    char buildInfo [] = "Gestion De Vuelos";
    ...
    do
    {
        ...
        switch ( menuPrincipal(buildInfo) )
        {
            ...
            case 3:
                ...
                {
                    printf("||\n|| //ERROR// no se encontro el archivo - Vuelos.csv - // lista NULA \n\n");
                }
                else
                {
            ...
            case 5:
                ...
                if ( listaFiltrada != NULL  )
                {
                    if ( ll_isEmpty(listaFiltrada) != 1 )
                    {
                        ...
                        employee_guardarListaAImprimir(listaFiltrada, "data.csv" );
            ...
            default:
                ...
                printf("||\n|| //Sugerencia// Intenta utilizando opciones correspondientes a las del menu.\n\n");
                system("pause");
                break;
        }
...
int menuPrincipal( char* buildInfo )
{
    ...
    printf("|| 3) Cargar lista de vuelos (csv)\n");
    printf("|| 4) Crear/Guardar lista de vuelos a imprimir(csv)\n");
    printf("|| 5) Filtrar...\n");
    printf("|| 6) Salir... \n");
